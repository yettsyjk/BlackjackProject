...
public class GamePlay {
	...
	private void showPlayerHand() {
		int userChoice = 0;
		//utilizing method from BlackjackHand.java, each card will be evaluated an add value of each additional card cumaltively
		do {
			System.out.println("------------------------------------------------");
			...
			//I may be experiencing variable shadowing as the evaluation player over 21 and dealer over 21
			//need more guidance and not sure how to fix this issue.
